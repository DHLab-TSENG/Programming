...
![](https://miro.medium.com/v2/resize:fit:524/format:webp/0*16wn36oYFyUAsFOA.gif) [Source](https://wakeupcoders.medium.com/the-beginners-guide-to-python-variables-896ee1a95cc7)
...
print('Learner') #decrease to indicate end of block
...
print('All done') #decrease to indicate end of block
```
...
`Function name`(`Argument`)，如`print`(`variable` or "value")
...
`function name`(`Argument 1`,`Argument 2`,...)，多個參數用`,`分隔

## Function Definition 設計函數

We define a function using the `def` reserved word

`def` `function name`(`arguments`)`:` statement 1 statement 1
...
#| echo: true
this_exam = 85
finel_grade = grade_ret(this_exam)
print(finel_grade)
```
:::
:::::
